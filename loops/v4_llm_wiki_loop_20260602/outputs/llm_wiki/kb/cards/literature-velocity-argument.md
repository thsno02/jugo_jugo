...
[^src-1]: `data/raw/webpage/complete-tech-live-frontier/text.txt` -- "Why we built it" 第一点 -- "The literature is moving faster than human curation can keep up with."
[^src-2]: `data/raw/webpage/complete-tech-live-frontier/text.txt` -- "Why we built it" 第一点 -- "A handcrafted bibliography goes stale before it ships. An LLM-maintained, deeply cross-referenced wiki absorbs new work without losing structure."
[^src-3]: `data/raw/webpage/complete-tech-live-frontier/text.txt` -- "Why we built it" 第一点 -- "the connections between papers are where the real signal is"
