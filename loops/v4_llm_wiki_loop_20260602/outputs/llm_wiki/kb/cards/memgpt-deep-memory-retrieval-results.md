...
related: [cross-session-continuity, long-term-memory-accuracy-gap, memgpt-conversation-opener-results, memgpt-memory-hierarchy, virtual-context-management]
---
...
[^src-2]: `data/raw/arxiv/arxiv-memgpt/agent_source_bundle.txt` -- tables/deep_memory_retrieval_table_singlecol.tex -- "GPT-4 Turbo & 35.3% & 0.359 \\ $+$ \textbf{MemGPT} & \textbf{93.4\%} & \textbf{0.827}"
...
[^src-4]: `data/raw/arxiv/arxiv-memgpt/agent_source_bundle.txt` -- sections/experiments.tex -- "MemGPT has significantly degraded performance using GPT-3.5, due to its limited function calling capabilities"
