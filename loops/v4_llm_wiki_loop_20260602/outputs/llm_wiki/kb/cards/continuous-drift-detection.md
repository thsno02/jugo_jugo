...
related: [data-catalog-as-enterprise-wiki, documentation-merge-gate, entrenchment-under-user-coupled-drift, llm-as-maintenance-engine]
  - lint-operation
...
然而，持续偏移检测在用户耦合漂移导致的固化场景下面临根本性挑战：固化的知识库在错误范式内可能保持内部一致性，使不一致检查无法有效发现问题[^dist-1]。
