...
summary: >-
  temporal-reasoning-difficulty（时序推理困难, temporal reasoning difficulty in dialogue）LoCoMo QA 中时序推理与人类差距最大：best-RAG 得分 42.1（与人类 92.6 差距 54.5%），long-context 模型仅得 25.0（差距 73.0%），LLM 难以理解对话中的时间概念和时序线索，与独立时序推理基准 TRAM 的发现一致
...
在时间推理维度上存在显著差距：best-RAG（observation top-10）得分 42.1（与人类 92.6 差距 54.5%）[^src-2]，而 long-context 模型（GPT-3.5-turbo-16K，12K 窗口）仅得 25.0（与人类差距 73.0%），基座模型中最好的 GPT-3.5-turbo 也仅 17.5[^src-3]。
