---
id: llm-wiki-ecosystem-velocity
title: LLM Wiki 生态形成速度
status: accepted
card_type: source_claim
tags: [llm-wiki, adoption, ecosystem, viral-spread, community]
created_time: 2026-06-05T10:00:00+08:00
edited_time: 2026-06-05T10:00:00+08:00
edited_entity: llm
source_ids: [aillm-wiki-directory]
justification: ../justification/llm-wiki-ecosystem-velocity.md
canonical_concept: llm-wiki-ecosystem-velocity
aliases: [生态形成速度, ecosystem velocity, 模式传播速度, adoption speed]
summary: >-
...
这一快速扩散留下了一个缺口：虽然解释模式的内容迅速涌现，但**缺少一个能直接下载并应用的资源聚合点**——无需再花一个周末试错[^src-2]。aillm.wiki 作为独立商业目录站应运而生，定位为"turns the spec into things you can actually download and apply"[^src-3]，提供模板、schema 和分步指南。
