...
[^src-1]: `/Users/lw/Desktop/GitHub/llm_wiki/jugo_jugo/data/raw/arxiv/arxiv-knowledge-compounding/source.pdf` -- Section 6.3 P25 -- "This is the mechanism that distinguishes Qing Claw from all other LLM Wiki implementations"
[^src-2]: `/Users/lw/Desktop/GitHub/llm_wiki/jugo_jugo/data/raw/arxiv/arxiv-knowledge-compounding/source.pdf` -- Section 6.3 P25 -- "the search results do not evaporate. Instead, the CEO actively passes them back to the wiki expert, which first reads the existing entity page, then merges the new facts and overwrites it"
