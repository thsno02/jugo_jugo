...
card: ../cards/map-of-content-pattern.md
...
- "If you only do one thing" 段 — "the two entry points to bookmark are wiki/mocs/communication-depth-spectrum.md (the 10-level walkthrough)"
范围论证：现有 index-based-navigation 卡专注于 index.md 作为平面目录的导航机制。MOC 是一种不同的导航结构——按主题组织的引导阅读路径，在摄入时动态更新。两者互补但机制不同，适合单独记录。
