...
card: ../cards/graphrag-global-sensemaking.md
...
- Section 2.2 — "GraphRAG contrasts with these approaches by focusing on a previously unexplored quality of graphs in this context: their inherent modularity"
范围论证：本卡涵盖 GraphRAG 的核心定位与方法总览——以图模块性解决全局 sensemaking 查询。这是论文的核心贡献声明，构成一个独立的原子概念。
