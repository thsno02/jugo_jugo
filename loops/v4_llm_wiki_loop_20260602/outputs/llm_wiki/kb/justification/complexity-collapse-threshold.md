...
card: ../cards/complexity-collapse-threshold.md
...
- stingraycharles 评论 — "The LLM can certainly not manage any non-local complexity right now"
- SOLAR_FIELDS 评论 — "A self referential layer like this that's entirely autonomous does feel completely valueless"
范围论证：复杂度崩溃阈值是三位不同评论者从不同角度独立到达的结论（wiki 规模、复杂度叠加、非局部复杂度），构成对 maintenance-cost-zero 论点的重要限定条件。该概念在 Karpathy 原文中未被讨论，是社区独有的贡献。
