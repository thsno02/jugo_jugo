...
card: ../cards/contradiction-as-asset.md
...
- L96 — "Two months later I needed the old reasoning to argue with someone, and it was gone."
范围论证：矛盾保留是一个独立的操作规则，与 lint 操作（检测矛盾）和源忠实性风险（内容漂移）相关但不重合。Lint 定义了检测什么，本卡定义了检测到矛盾后怎么做。该规则有具体的实践验证（第 4 个月覆盖事故），具有明确的操作指导意义。
