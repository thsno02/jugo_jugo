...
card: ../cards/cost-independence-assumption.md
...
- Section 1.1 P3 — "Both frameworks treat cost as an independent, non-cumulative marginal expense"
范围论证：成本独立性假设批判是知识复利理论的逻辑起点——先识别现有框架的隐含假设，再提出修正。作为独立卡因其本身是一个可复用的批判性洞察：任何将任务成本视为独立的 LLM 经济分析都隐含了 A1-A3 假设。
