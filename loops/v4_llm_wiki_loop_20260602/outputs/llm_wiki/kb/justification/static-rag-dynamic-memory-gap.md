...
card: ../cards/static-rag-dynamic-memory-gap.md
...
范围论证：静态 RAG 与动态记忆需求之间的鸿沟是 Zep 论文的核心动机论述，独立于 Zep 的具体技术方案。它与已有卡 rag-wiki-synthesis-distinction 和 retrieval-vs-maintenance 相关但不重复——前者关注 RAG 与 wiki 的综合区别，后者关注检索与维护的取舍，本卡聚焦 RAG 的静态性问题。
