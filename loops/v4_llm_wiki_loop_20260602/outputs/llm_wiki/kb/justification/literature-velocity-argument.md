...
card: ../cards/literature-velocity-argument.md
...
- "Why we built it" 第一点 — "the connections between papers are where the real signal is"
范围论证：现有 maintenance-cost-zero 卡论证 LLM 使维护成本趋零，但未涉及文献增速超出人工能力这一独立维度。本卡提出的不是「不愿做」而是「做不完」的论点是一个独立的原子论证，适合作为 source_claim 单独记录。
