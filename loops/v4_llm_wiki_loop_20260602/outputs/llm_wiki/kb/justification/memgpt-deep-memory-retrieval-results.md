...
card: ../cards/memgpt-deep-memory-retrieval-results.md
...
- sections/experiments.tex — "MemGPT clearly improves the performance of the underlying base LLM"
范围论证：DMR 是 MemGPT 论文的核心实验之一，结果（93.4% vs 35.3%）直接证明虚拟上下文管理在多会话一致性任务上的效果，作为独立的实验证据卡提取。
