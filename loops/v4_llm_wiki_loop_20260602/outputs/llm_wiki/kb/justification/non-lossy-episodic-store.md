...
card: ../cards/non-lossy-episodic-store.md
...
范围论证：无损存储与双向溯源是 Graphiti 的一项设计原则，与 llm-wiki 中的 source-faithfulness-risk 和 originals-verbatim-capture 卡片在理念上相关。它独立于三层架构的整体描述，聚焦于数据完整性和溯源能力这一具体设计决策。
