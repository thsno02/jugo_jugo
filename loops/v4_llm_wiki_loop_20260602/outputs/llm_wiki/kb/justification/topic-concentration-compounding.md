...
card: ../cards/topic-concentration-compounding.md
...
- Table 4 P19 — 三种集中度场景下的30天仿真数据
范围论证：主题集中度是知识复利效应的关键调节变量，直接决定了不同应用领域的复利收益差异，并为 Liu et al. 的可用性鸿沟提供了全新解释。与 use-case-domains 卡相关但角度不同——后者列举领域，本卡解释域间差异的机制。
