...
card: ../cards/memory-value-granularity-tradeoff.md
...
- Section 5.2 — "The only exception is with multi-session reasoning questions, where fact decomposition consistently improves performance"
范围论证：存储粒度权衡是记忆系统设计的核心决策之一，与 chunk-size-tradeoff 相关但专注于对话记忆场景，提供了不同层级的定量比较证据，值得独立成卡。
