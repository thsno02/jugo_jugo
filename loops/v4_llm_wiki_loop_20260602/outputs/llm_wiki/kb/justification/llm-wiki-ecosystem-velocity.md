...
card: ../cards/llm-wiki-ecosystem-velocity.md
...
- L43 — "the rest of the internet explains the pattern, we show you how to run it on your own machine, your own vault, your own papers"
范围论证：与 pattern-naming-resonance（命名共振机制）不同，本卡聚焦于生态形成的具体表现和速度——一周内出现开源实现、视频讲解、博客文章和商业目录。这是对传播速度的事实性记录，而非对共振原因的解释。
