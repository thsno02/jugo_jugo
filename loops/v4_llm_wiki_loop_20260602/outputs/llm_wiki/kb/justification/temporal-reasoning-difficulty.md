...
card: ../cards/temporal-reasoning-difficulty.md
...
- Section 6.1 — "LLMs face challenges in understanding time concepts within dialogues, consistent with TRAM"
范围论证：时序推理作为 LLM 对话记忆的特定短板，有独立的学术和工程价值，值得从 LoCoMo 整体基准中单独成卡。
