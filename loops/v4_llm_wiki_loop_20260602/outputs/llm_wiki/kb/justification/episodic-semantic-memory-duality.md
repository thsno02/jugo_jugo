...
card: ../cards/episodic-semantic-memory-duality.md
...
范围论证：情景-语义记忆二分法是 Zep 架构的设计理念基础，独立于具体的三层实现细节。它连接了认知心理学与 agent 记忆工程，是一个跨学科的概念性知识点。已有卡 lightmem-three-stage-memory 描述 LightMem 的三阶段记忆，本卡关注不同系统（Zep/AriGraph）中的情景-语义二分设计原则。
