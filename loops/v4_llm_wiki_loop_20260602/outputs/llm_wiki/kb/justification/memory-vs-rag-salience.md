...
card: ../cards/memory-vs-rag-salience.md
...
范围论证：记忆系统 vs RAG 是论文的核心比较之一。该卡片聚焦于"为什么提取显著事实优于检索原始块"这一机制性解释，与 KB 中已有的 chunk-size-tradeoff 和 full-context-anti-rag 形成互补。
