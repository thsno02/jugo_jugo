...
card: ../cards/production-scale-wiki-reference.md
...
- "Why we built it" 第三点 — "Showing what a 120-page, 1400-link, schema-disciplined implementation looks like... is more useful than another think-piece about second brains."
范围论证：现有 KB 的 llm-wiki-pattern 和 use-case-domains 卡片描述模式概念和应用领域，但无具体的规模化实现实例。本卡记录首个公开的生产级参考，提供具体数字证据（120 页、1400 链接、27 源），不重复模式定义本身。
