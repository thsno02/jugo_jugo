...
card: ../cards/full-stack-locality.md
...
- L115 — "For everything else, I'll be honest — Obsidian with a good plugin is more practical today."
范围论证：三层本地性谱系是此博文的核心原创分析贡献。既有 KB 中 llm-wiki-pattern 定义了模式本身、obsidian-tooling 列举了 Obsidian 生态工具，但均未将三种方案按存储/计算两维度分层对比。此卡填补了"为什么选择全栈本地"的决策框架空白。
