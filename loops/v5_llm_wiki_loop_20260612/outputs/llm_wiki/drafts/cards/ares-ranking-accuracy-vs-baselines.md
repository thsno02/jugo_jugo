...
tags: [kendall-tau, ragas, gpt-3.5, ranking-accuracy, rag-evaluation]
...
aliases: [ARES vs RAGAS, ARES ranking performance, Kendall's tau comparison]
summary: >-
  在 KILT + SuperGLUE 六个数据集的 mock RAG 系统排名实验中，ARES Kendall's tau 比 RAGAS 平均高 0.065 (context relevance) 和 0.132 (answer relevance)；比 few-shot GPT-3.5 judge 平均高 0.06。预测准确率方面 ARES 比 RAGAS 高 59.9 (C.R.) 和 14.4 (A.R.) 个百分点。ARES 比 1350 个 sampled annotations 的 tau 高 0.08，同时少用 78% 标注。
related: []
---
