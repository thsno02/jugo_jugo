...
tags: [llm-wiki, index, navigation, scale-boundary, rag-alternative]
created_time: 2026-06-12T15:06:00+08:00
edited_time: 2026-06-12T15:06:00+08:00
edited_entity: llm
...
aliases: [index.md navigation, index-based retrieval, 索引文件导航, wiki index]
summary: >-
  index-as-navigation 描述 LLM Wiki 使用 index.md（按类别组织的页面目录）替代 embedding-based RAG 的检索策略；在约 100 sources / 数百页规模下"surprisingly well"有效；更大规模需要专用搜索工具如 qmd
