...
tags: [rag-evaluation, automated-evaluation, llm-judge, ppi]
...
aliases: [ARES, Automated RAG Evaluation System]
summary: >-
  ARES (Automated RAG Evaluation System) 是首个为 RAG 管线各组件生成定制化 LLM judge 的自动化评估框架。通过三阶段流程——合成数据生成、轻量 LLM judge 微调、PPI 置信区间排序——仅需约 150 人工标注即可准确评估 RAG 系统的 context relevance、answer faithfulness、answer relevance。来自 Stanford/Databricks，代码开源于 GitHub。
related: []
---
