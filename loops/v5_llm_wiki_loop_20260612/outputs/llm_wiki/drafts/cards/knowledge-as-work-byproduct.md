...
tags: [knowledge-capture, zero-overhead, byproduct, workflow-integration]
...
aliases: [knowledge graph grows as a byproduct of work, 知识作为副产品]
summary: >-
  企业 LLM wiki 的关键设计原则：知识图谱作为正常工作的副产品增长而非作为额外工作 the knowledge graph grows as a byproduct of work not as additional work；团队不改变工作方式 PR合并 Slack讨论解决 决策落地时系统自动检测受影响文档并草拟更新；这区别于此前所有失败的文档化 mandate
related: [enterprise-llm-wiki-architecture, maintenance-loop-as-core-innovation]
---
