...
status: draft
card_type: mechanism
tags: [llm-wiki, lessons-learned, error-patterns, self-improvement]
...
aliases: [lessons learned, /wiki:ll, error-fix patterns, 经验提取]
summary: >-
  lessons-learned-extraction 机制：从当前会话提取经验教训包括 error-fix patterns 用户纠正和发现，保存为结构化笔记供 wiki 后续查询，--rules 选项输出可执行规则而非散文
related: [llm-wiki-compounding-knowledge, llm-wiki-audit-trust-verification]
---
