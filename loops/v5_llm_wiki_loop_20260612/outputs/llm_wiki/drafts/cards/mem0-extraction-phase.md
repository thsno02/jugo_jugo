...
status: draft
card_type: mechanism
tags: [memory-extraction, context-window, conversation-summary, llm-pipeline]
...
aliases: [extraction phase, memory extraction, 提取阶段, fact extraction]
summary: >-
  Mem0 extraction phase 提取阶段在接收新消息对时启动，结合对话摘要 conversation summary S 和最近 m=10 条消息作为上下文，通过 LLM 提取函数 phi 产出候选记忆集合 Omega。异步摘要生成模块定期刷新对话摘要，不阻塞主处理管线。双重上下文来源：全局主题理解 + 精细时间上下文。
related: []
---
