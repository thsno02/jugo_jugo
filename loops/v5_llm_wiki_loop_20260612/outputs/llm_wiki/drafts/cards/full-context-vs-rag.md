...
tags: [llm-wiki, rag, context-window, architecture-decision]
...
aliases: [full-context strategy, non-RAG, 全量上下文, 非RAG策略]
summary: >-
  Karpathy LLM Wiki 采用全量上下文策略而非 RAG：将完整 Wiki 内容喂给 LLM 而非分块检索。
  理由是 RAG 将知识碎片化，破坏 LLM 跨知识图谱推理的能力。因此强烈推荐长上下文模型（1M+ tokens）。
related: [karpathy-llm-wiki-concept, llm-wiki-model-recommendations]
---
