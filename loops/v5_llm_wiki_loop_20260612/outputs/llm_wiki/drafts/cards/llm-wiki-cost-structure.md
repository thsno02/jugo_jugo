...
tags: [llm-wiki, cost, open-source, claude-api]
...
aliases: [wiki cost, zero cost, cost structure]
summary: >-
  LLM wiki 成本结构 cost-structure：开源 LLM (Llama 3) + Obsidian 完全免费；Claude API 每篇文档约 0.01-0.10 欧元；100 篇文档规模总计不到 10 欧元，维护成本低（增量 ingestion）。个人使用几乎零成本。
related: [llm-wiki-setup-procedure, llm-wiki-scale-limitations]
---
