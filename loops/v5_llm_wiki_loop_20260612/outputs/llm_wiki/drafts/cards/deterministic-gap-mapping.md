...
status: draft
card_type: mechanism
tags: [gap-mapping, knowledge-growth, promotion, wiki]
...
aliases: [kb_map_gaps, kb_promote_gap, gap mapping, gap promotion, 知识缺口映射]
summary: >-
  deterministic-gap-mapping 确定性知识缺口映射通过 kb_map_gaps 发现 wiki 中的知识空白，
  kb_promote_gap 将缺口提升为正式 derived note（concept/entity/synthesis），
  覆盖 ingest 层之上的 durable knowledge growth。
related: []
---
