...
tags: [context-relevance, sentence-extraction, retrieval-quality, rag-evaluation]
...
aliases: [Context Relevance, RAGAS context relevancy, 上下文相关性指标, CR]
summary: >-
  RAGAS Context Relevance 通过 LLM 从 context 中提取回答问题所需的关键句子子集 S_ext，
  CR = |S_ext| / total_sentences_in_context。惩罚检索结果中的冗余信息。WikiEval 准确率 0.70，
  是三维度中最难评测的——ChatGPT 在长 context 下提取关键句子时表现不稳定。
related: [ragas-framework-overview, ragas-faithfulness-metric, ragas-answer-relevance-metric, lost-in-the-middle-effect-on-rag]
---
