...
tags: [selfcheckgpt, hallucination-detection, sampling-consistency, black-box, closed-model]
...
aliases: [SelfCheckGPT, self-check GPT, 采样一致性幻觉检测]
summary: >-
  SelfCheckGPT (Manakul et al. 2023) 针对不提供 token probability 的 closed-model 提出幻觉检测方法：
  多次采样答案，核心假设为事实性答案在不同采样间语义一致性更高，而幻觉答案的采样结果倾向于不一致。
  属于 zero-resource black-box hallucination detection。
related: [ragas-faithfulness-metric, rag-evaluation-motivation]
---
