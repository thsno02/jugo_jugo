...
status: draft
card_type: insight
tags: [maintenance-loop, llm-wiki, knowledge-management]
...
aliases: [maintenance loop, 维护循环, active maintenance loop]
summary: >-
  LLM Wiki 的核心创新在于 maintenance loop 维护循环而非 search layer 检索层；Zettelkasten 理论优美但实践失败因为维护杀死了它；LLM Wiki 将维护从人类转移到 LLM；知识系统的价值在于笔记保持准确而非更好地查询可能不准确的笔记
