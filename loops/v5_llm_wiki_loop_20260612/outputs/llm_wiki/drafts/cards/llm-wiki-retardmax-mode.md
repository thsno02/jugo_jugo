...
status: draft
card_type: mechanism
tags: [llm-wiki, retardmax, rapid-research, aggressive-ingestion]
...
aliases: [retardmax, retardmaxxing, --retardmax, 快速出稿模式]
summary: >-
  retardmax-mode：灵感来自 Elisha Long 的 retardmaxxing 哲学（先行动后思考），十个并行 agents 跳过规划撒最广的网，激进摄取快速编译后续再 lint，可用于 research 和 output 命令
related: [llm-wiki-parallel-multi-agent-research]
---
