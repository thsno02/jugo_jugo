...
status: draft
card_type: mechanism
tags: [llm-wiki, gap-report, iterative-research, follow-up]
...
aliases: [gap report, gap drilling, iterative research, 知识空白报告]
summary: >-
  gap-report-iterative-research 机制：每轮研究后展示已覆盖内容和缺失内容及建议后续，2+ gaps 时提供交互选择并行关闭，--min-time 支持多轮 gap drilling 每轮钻入前轮发现的空白
related: [llm-wiki-parallel-multi-agent-research, llm-wiki-plan-mode-research]
---
