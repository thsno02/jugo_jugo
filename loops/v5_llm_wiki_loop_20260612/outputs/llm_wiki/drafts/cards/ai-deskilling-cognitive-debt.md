...
tags: [ai-deskilling, cognitive-debt, knowledge-gaps, delegation-risk]
...
aliases: [AI de-skilling, 认知去技能化, persistent brain gap, cognitive outsourcing]
summary: >-
  过度委托架构和发现工作给多代理工作流导致 persistent brain gap——一种新型技术债务；知识差距越大越拖延真正工作；交付物退化为一堆 markdown files。使用者报告失去深度思考能力，LLM wiki 工作流具有成瘾性但产生认知空洞。
related: [pkm-process-over-artifact]
---
