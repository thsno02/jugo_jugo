...
status: draft
card_type: mechanism
tags: [entity-resolution, knowledge-graph, cross-tool, semantic-linking]
...
aliases: [cross-tool semantic resolution, 跨工具语义解析, entity resolution]
summary: >-
  企业 LLM wiki 的链接机制需从 Obsidian 文件内反向链接升级为跨工具实体解析；需理解 payments service 设计文档 = payments-service GitHub repo = @payments-team Slack channel 为同一实体；本质上更接近知识图谱而非链接 Markdown 文件 vault
related: [personal-to-enterprise-scaling-barriers, karpathy-llm-wiki-pattern]
---
