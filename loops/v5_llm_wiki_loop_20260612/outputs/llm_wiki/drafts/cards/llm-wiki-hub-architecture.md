...
tags: [llm-wiki, directory-structure, knowledge-management]
...
aliases: [hub architecture, wiki hub, llm-wiki directory structure]
summary: >-
  llm-wiki hub architecture 目录分层设计：hub（~/wiki/）为轻量注册中心仅含 wikis.json 和 _index.md，topic wikis（~/wiki/topics/<name>/）为隔离研究区域含 raw/ wiki/ output/ inventory/ datasets/ 等子目录，各层职责明确分离
related: [llm-wiki-immutable-raw-sources, llm-wiki-topic-wiki-isolation, llm-wiki-index-derived-cache]
---
