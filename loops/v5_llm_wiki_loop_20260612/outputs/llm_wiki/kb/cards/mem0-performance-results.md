...
- Mem0 实验结果
summary: Mem0 在 LOCOMO 上的实验结果：single-hop Judge=67.13 F1=38.72（SOTA），multi-hop Judge=51.15
  F1=28.64（SOTA），temporal Judge 方面 Mem0^g=58.13 F1=51.55（SOTA），open-domain Zep Judge=76.60
  略优于 Mem0^g=75.71。Mem0 相对 OpenAI memory 在 Judge 上有 26% 相对改进。Mem0 base 擅长 single-hop/multi-hop，Mem0^g
  擅长 temporal/open-domain。
related:
