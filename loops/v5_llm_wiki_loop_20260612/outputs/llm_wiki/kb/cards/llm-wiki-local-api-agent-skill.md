...
summary: LLM Wiki 内置本地 HTTP API（127.0.0.1:19828，token 保护）：支持 hybrid search（keyword
  + vector）、 文件读取、wikilinks graph 遍历、sources rescan。配套 agent skill（npx skills add）可一键安装到
