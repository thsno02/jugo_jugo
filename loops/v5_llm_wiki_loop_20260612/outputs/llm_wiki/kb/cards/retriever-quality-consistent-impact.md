...
aliases:
- Retriever Matters Consistently
- 检索器质量一致性影响
summary: RAGChecker 实验表明检索器质量对 RAG 系统性能的提升是一致的（与 generator 选择无关）。在固定 generator 条件下，从 BM25 切换到 E5-Mistral 使 claim recall 从 74.0 提升至 83.5，context precision 从 52.3 提升至 61.8，整体 F1 从约 45 提升至约 48。该改善对四种 generator（GPT-4/Llama3-8B/Llama3-70B/Mixtral-8x7B）均一致成立。
related:
