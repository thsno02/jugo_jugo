...
summary: idea-file-concept Idea File概念 LLM Agent时代的知识分享方式变革 Karpathy提出在LLM agent时代， 分享具体代码/应用的意义降低，更有效的方式是分享抽象的"idea file"，接收者的agent可根据特定需求 定制并构建。故意保持抽象/模糊因为方向众多。以GitHub Gist格式发布。讨论区可供他人调整或贡献想法。
related:
