...
- LLM Wiki schemas
- CLAUDE.md templates
summary: LLM Wiki schema 模板体系包含 5 种 battle-tested 模板：general、research、engineering、product、SEO。每种模板由 schema.md 与 CLAUDE.md 配对组成，指导 LLM 在首次尝试即产出清洁 entity pages。选择匹配思维方式的 schema 是最难决策点。
related:
