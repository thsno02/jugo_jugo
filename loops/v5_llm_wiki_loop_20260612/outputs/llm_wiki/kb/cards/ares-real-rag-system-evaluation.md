...
aliases:
- ARES on real RAG systems
- ARES real-world evaluation
summary: 在 NQ/WoW/FEVER 上评估真实 RAG 系统（BM25、Ada embeddings、ColBERTv2 检索器 + MPT-7b、GPT-3.5、GPT-4
  生成器 + Facebook RAG），ARES 平均 Kendall's tau 为 0.91 (C.R.) 和 0.97 (A.R.)，比 RAGAS 高
  0.16 (C.R.) 和 0.15 (A.R.)。PPI 置信区间平均宽 7.4 点 (C.R.) 和 6.1 点 (A.R.)，ground truth 捕获率超
  95%。最佳检索器 ColBERTv2，最佳生成器 GPT-4。
related:
- ares-mock-rag-system-construction
- ares-cross-domain-transfer
