...
- workflow
- wiki-maintenance
created_time: 2026-06-12 15:02:00+08:00
edited_time: 2026-06-12 15:02:00+08:00
edited_entity: llm
source_ids:
...
summary: ingest-operation 是 LLM Wiki 的核心操作：LLM 读取新 source 后讨论要点、写摘要页、更新 index、更新相关实体/概念页、追加 log；单次 ingest 可触及 10-15 wiki 页面
related:
