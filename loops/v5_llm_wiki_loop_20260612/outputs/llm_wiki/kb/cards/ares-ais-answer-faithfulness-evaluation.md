...
- ARES hallucination detection
summary: 'ARES 在 AIS 归因基准的 WoW 和 CNN/DM 数据集上评估 answer faithfulness，预测正负分割比例与 ground
  truth 相差在 2.5 个百分点内（WoW: 0.478 vs 0.458; CNN/DM: 0.835 vs 0.859）。仅用 200 个标注的 human
  preference validation set。Judge 准确率 WoW 62.5%、CNN/DM 84.0%。证明 ARES 能在真实 RAG 系统中可靠区分忠实与幻觉答案。'
related:
