...
- associative-trails
- knowledge-topology
created_time: 2026-06-12 15:07:00+08:00
edited_time: 2026-06-12 15:07:00+08:00
edited_entity: llm
source_ids:
...
aliases:
- associative trails
- cross-references as value
- 连接即价值
- Memex vision
summary: connections-as-value 是 LLM Wiki 继承自 Memex (1945) 的认识论主张：文档间的连接（cross-references,
  associative trails）与文档本身同等有价值；LLM 解决了 Bush 遗留的维护问题使这一愿景首次可实现
related:
