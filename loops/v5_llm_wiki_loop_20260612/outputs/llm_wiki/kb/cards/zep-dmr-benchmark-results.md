...
- DMR benchmark
- DMR evaluation
summary: Zep 在 DMR benchmark 上达到 94.8%（gpt-4-turbo）/98.2%（gpt-4o-mini），优于 MemGPT 的 93.4%。但论文同时批评 DMR 的局限：每对话仅 60 条消息可完全放入上下文窗口，仅含 单轮事实检索问题，措辞模糊，不代表企业用例。Full-context baseline 已达 94.4%/98.0%， 凸显该基准对记忆系统评估的不充分性。
related:
