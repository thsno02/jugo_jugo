...
summary: dataset-manifest-system：datasets/ 存储 manifests samples profiles 和 query recipes 索引大数据或外部数据而不复制到 raw/，manifests 可指向本地路径 URLs archives，wiki 成为界面数据留在原处
related:
