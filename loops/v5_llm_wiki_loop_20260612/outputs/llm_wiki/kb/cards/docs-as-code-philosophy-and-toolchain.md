...
- docs-as-code
- docs like code
summary: Docs as Code (Documentation as Code) 是一种用与代码相同工具编写文档的哲学。核心工具链包括 Issue Trackers、Version Control (Git)、Plain Text Markup (Markdown, reStructuredText, Asciidoc)、Code Reviews、Automated Tests。遵循开发团队工作流，整合进产品团队，营造
  writers 和 developers 共同拥有文档所有权的文化。
related:
- docs-as-code-adoption-benefits
---
