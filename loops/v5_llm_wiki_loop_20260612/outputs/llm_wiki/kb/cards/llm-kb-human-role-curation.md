...
- 方向づけ
- curation
- human role in LLM KB
summary: 'LLM KB 中的人机分工: LLM 承担人类易厌烦的保守任务(index 更新/cross-reference/一貫性チェック/統合更新);
  人类专注策展(キュレーション)和方向设定(方向づけ)——source 收集/schema 设计/意思决定。核心前提: LLM 不会对枯燥重复任务放弃。llm-kb-human-role-curation
  キュレーション 方向づけ 人間 役割'
related:
