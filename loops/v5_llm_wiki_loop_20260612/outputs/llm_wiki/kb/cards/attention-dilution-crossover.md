...
- attention dilution
- scalability gap
- document-count crossover
- lost in the middle
- 注意力稀释
- 文档数交叉
summary: 'Full-context KV cache 推理在 30 文档/67K tokens(70% 窗口填充)时优于 RAG(4.38 vs 4.08),
  但在 80 文档/55-95K tokens(57-99% 填充)时因注意力稀释劣于 RAG(3.47 vs 3.64)。RAG 在 15 个主题中 13 个胜出。机制为
  lost in the middle: FC 产生 17% score-1(vs Policygenius 1.2%), 557 个案例中 FC 评分 1 但
  RAG>=4——模型有全部文档但无法定位相关段落。交叉点在 30-80 文档之间。'
related:
