...
aliases:
- curator over librarian
- 策展优于检索
summary: '策展优于检索的论证 (llm-wiki-curation-over-retrieval): 材料给出三条动机——(1) 文献增速超过人工策展能力，论文间连接才是真正信号，手工文献目录在发布前就过时；(2)
  分析框架（如 depth spectrum）需要活的家，手动维护相当于四分之一人力，schema 驱动下 LLM 在摄入时作为副产品完成；(3) 生产级参考实现比再写一篇第二大脑随想更有用。'
related:
- llm-wiki-pattern
