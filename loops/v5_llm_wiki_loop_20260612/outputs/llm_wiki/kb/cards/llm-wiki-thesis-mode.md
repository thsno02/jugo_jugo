...
summary: thesis-driven-research 模式：从特定声明出发，agents 分为 supporting opposing mechanistic
  meta adjacent 五组平衡设计，无关源被跳过保持 wiki 精简，输出 verdict（supported/partially supported/contradicted/insufficient
  evidence/mixed），第二轮反确认偏差
related:
- llm-wiki-gap-report-iterative
