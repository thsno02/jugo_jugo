...
- wiki ingest
- LLM KB 取込
summary: 'LLM Knowledge Base 的 Ingest 操作: 新 source 加入时 LLM 读取文档、写 summary、更新关联 entity
  page、改 index.md。核心特征是"統合"而非单纯索引——既有知识与矛盾也被解消。llm-kb-ingest-operation ingest 取り込み'
related:
