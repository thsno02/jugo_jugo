...
- rag-alternative
- compounding
created_time: 2026-06-12 15:00:00+08:00
edited_time: 2026-06-12 15:00:00+08:00
edited_entity: llm
source_ids:
...
- 持久性复合知识库
summary: persistent-compounding-artifact 是 LLM Wiki 的核心设计理念：知识编译一次后保持更新（compiled once,
  kept current），区别于 RAG 每次查询从头推导；wiki 随每个 source 和每次提问累积变得更丰富
related:
- openkb-compiled-wiki-over-rag
- ripple-effect-ingest
- wiki-compounding-productivity-loop
- connections-as-value
- human-llm-cognitive-division
- index-as-navigation
- ingest-operation
- lint-as-quality-driver
- query-as-contribution
