...
- 性价比策略
summary: Value-First 策略：不需要旗舰模型。推荐 DeepSeek V4-Flash（1M，最低成本 $0.14/M）、 Gemini-3.5-Flash（1M，4 倍速）、Qwen3.6-Plus（1M）、Grok-4（2M）等性价比选项。 旗舰模型（Opus 4.7/GPT-5.5）仅选择性使用。本地模型上下文较小，建议云端 ingest + 本地 query。
related:
- full-context-vs-rag
- extraction-granularity-levels
- llm-wiki-multi-provider-support
---
