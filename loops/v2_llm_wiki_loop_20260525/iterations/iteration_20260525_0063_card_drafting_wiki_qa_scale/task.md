...
- `candidate_id`: `候选 11`
- `candidate_statement`: 被引用推文描述，当某个近期研究 wiki 达到约 100 篇文章、约 400K words 的小规模时，可以让 LLM agent 针对该 wiki 回答复杂问题并继续研究。
- `candidate_fact_type`: `known_fact`
- `candidate_scope`: 仅限被引用推文对某个近期研究 wiki 规模和问答用法的描述。
- `candidate_source_evidence`: `data/raw/webpage/karpathy-x-launch-post/raw.json`, JSON pointer `$.tweet.quote.text`

选择理由：候选 11 的证据集中在一个 JSON 字段，事实边界清楚；它记录的是被引用推文中一个具体研究 wiki 的规模与 Q&A/research 用法，不重复已采纳的 query answer writeback 或 health checks 卡。选择不基于主题覆盖、hub、cluster 或补齐叙事结构。
...
- `llm_wiki/loop/iterations/iteration_20260525_0063_card_drafting_wiki_qa_scale/loop_status.md`
- `llm_wiki/loop/iterations/iteration_20260525_0063_card_drafting_wiki_qa_scale/loop_delivery.md`
- `llm_wiki/loop/iterations/iteration_20260525_0063_card_drafting_wiki_qa_scale/read_log.md`
- `llm_wiki/loop/iterations/iteration_20260525_0063_card_drafting_wiki_qa_scale/artifacts/draft_card.md`
- `llm_wiki/loop/iterations/iteration_20260525_0063_card_drafting_wiki_qa_scale/artifacts/provenance.md`
