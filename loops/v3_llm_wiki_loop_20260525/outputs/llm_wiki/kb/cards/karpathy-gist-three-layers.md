...
related: [agents-md-as-schema-layer, robin-cartier-schema-as-product-doc, llm-wiki-three-layer-architecture]
---
...
边界：
- gist 自己强调"这文档故意是抽象的"[^src5]——具体的目录结构、页面格式、工具选择都依赖具体领域，应由用户与 LLM 协作实例化；
