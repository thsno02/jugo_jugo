...
edited_time: 2026-05-28T11:17:00+08:00
edited_entity: llm
...
related: [auto-index-replaces-rag-at-small-scale, agents-md-as-schema-layer]
---
...
- 它解释了 Karpathy 自己的实践规模——超过 100 篇文章、40 万字——为什么不需要向量数据库[^v3-1]：在该规模下，markdown + Obsidian backlink 就够[^src2]；向量检索只有上千 chunk 才必要。
