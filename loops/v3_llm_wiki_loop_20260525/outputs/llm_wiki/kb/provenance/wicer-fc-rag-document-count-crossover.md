...
card: ../cards/wicer-fc-rag-document-count-crossover.md
material_id: arxiv-wicer
digest_id: digest_arxiv-wicer
source_paths:
  - data/raw/arxiv/arxiv-wicer/agent_source_bundle.txt
draft_card: ../../drafts/cards/wicer-fc-rag-document-count-crossover.md
draft_provenance: ../../drafts/provenance/wicer-fc-rag-document-count-crossover.md
similarity_result: ../../drafts/similarity/wicer-fc-rag-document-count-crossover.json
comparison_provenance: ../../drafts/comparison/wicer-fc-rag-document-count-crossover.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T14:30:00+08:00
  gate_notes: 6/6 通过；Policygenius 与 RepLiQA 实证、4.38/4.08 vs 3.47/3.64 翻转、557 lost-in-the-middle 案例、TTFT 7.3×→4.6× 均回到 L568–690。
...
- 检查要点：
  - 非标题复述：正文展开 FC vs RAG 翻转 + 机制 + 量化 Q4 退化 + TTFT 缩水 + 三条操作启示。
  - 知识密度：实证 + 机制 + 操作建议。
  - 源支撑：source_ids 含 arxiv-wicer；L568–614 / L656–690 / L634–644 verbatim。
  - References / Footnotes 齐备。
  - frontmatter 完整且合法。
  - related 已填充：6 张 WiCER / GraphRAG / Locomo / Karpathy 相邻卡。

## 备注

与 `wicer-cegar-compile-evaluate-refine`、`wicer-blind-compilation-catastrophic-loss` 在主题上互补——前者讲算法、本卡讲它出现的"经验前提"。可与 v2 中 `auto-index-replaces-rag-at-small-scale` 比较：v2 卡讨论的是"小规模 auto-index 取代 RAG"，本卡讨论的是"全上下文 KV cache 与 RAG 随文档数量的翻转"，抽象层级不同。

## 相关 v3 draft 工件

- draft card: `../../drafts/cards/wicer-fc-rag-document-count-crossover.md`
- draft provenance: `../../drafts/provenance/wicer-fc-rag-document-count-crossover.md`
- similarity: `../../drafts/similarity/wicer-fc-rag-document-count-crossover.json`
- comparison provenance: `../../drafts/comparison/wicer-fc-rag-document-count-crossover.md`
