...
card: ../cards/mem0-graph-memory-variant.md
material_id: arxiv-mem0
digest_id: digest_arxiv-mem0
source_paths:
  - data/raw/arxiv/arxiv-mem0/agent_source_bundle.txt
draft_card: ../../drafts/cards/mem0-graph-memory-variant.md
draft_provenance: ../../drafts/provenance/mem0-graph-memory-variant.md
similarity_result: ../../drafts/similarity/mem0-graph-memory-variant.json
comparison_provenance: ../../drafts/comparison/mem0-graph-memory-variant.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T11:55:00+08:00
  gate_notes: 6/6 项通过；图结构 + 双路检索 + 冲突 invalidate + LOCOMO 数字对比 + Neo4j 实现细节齐备。
...
- 类型：publication_gate
- 结果：passed
- 决定时间：2026-05-27T11:55:00+08:00
- 检查要点：
  - mechanism 卡涵盖图结构、抽取管线、冲突处理、双路检索、性能权衡，非标题复述。
  - 知识密度合格。
  - source_ids 含 `arxiv-mem0`，正文锚到 proposed_work.tex 第 1163-1188 行 / result.tex 第 1047-1085 / 1259-1260 行。
...
- 与同 batch `mem0-extract-update-pipeline`、`mem0-tool-call-add-update-delete-noop`、`mem0-locomo-benchmark-evaluation` 构成 Mem0 的四卡集。
- v2 卡片中无对应条目。

## 相关 v3 draft 工件

- draft card: `../../drafts/cards/mem0-graph-memory-variant.md`
- draft provenance: `../../drafts/provenance/mem0-graph-memory-variant.md`
- similarity: `../../drafts/similarity/mem0-graph-memory-variant.json`
- comparison provenance: `../../drafts/comparison/mem0-graph-memory-variant.md`
