...
card: ../cards/mem0-tool-call-add-update-delete-noop.md
material_id: arxiv-mem0
digest_id: digest_arxiv-mem0
source_paths:
  - data/raw/arxiv/arxiv-mem0/agent_source_bundle.txt
draft_card: ../../drafts/cards/mem0-tool-call-add-update-delete-noop.md
draft_provenance: ../../drafts/provenance/mem0-tool-call-add-update-delete-noop.md
similarity_result: ../../drafts/similarity/mem0-tool-call-add-update-delete-noop.json
comparison_provenance: ../../drafts/comparison/mem0-tool-call-add-update-delete-noop.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T12:01:00+08:00
  gate_notes: 6/6 项通过；四操作语义 + ClassifyOperation 伪代码 + InformationContent 门槛 + 与 metabolism 立场对照齐备。
...
- 类型：publication_gate
- 结果：passed
- 决定时间：2026-05-27T12:01:00+08:00
- 检查要点：
  - mechanism 卡四操作表 + 伪代码 + 与 CRUD 差别 + 边界齐全，非标题复述。
  - 知识密度合格。
  - source_ids 含 `arxiv-mem0`，正文锚到 appendix.tex 第 911-966 行 + proposed_work.tex 第 1155 行。
...
- 与本 batch 的 `audit-by-suspension-against-entrenchment` 形成有意义的对照——两种保留策略对照。
- v2 卡片中无 mem0 相关条目，无重叠。

## 相关 v3 draft 工件

- draft card: `../../drafts/cards/mem0-tool-call-add-update-delete-noop.md`
- draft provenance: `../../drafts/provenance/mem0-tool-call-add-update-delete-noop.md`
- similarity: `../../drafts/similarity/mem0-tool-call-add-update-delete-noop.json`
- comparison provenance: `../../drafts/comparison/mem0-tool-call-add-update-delete-noop.md`
