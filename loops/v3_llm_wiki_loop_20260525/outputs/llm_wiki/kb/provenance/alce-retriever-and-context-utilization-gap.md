...
card: ../cards/alce-retriever-and-context-utilization-gap.md
material_id: arxiv-alce
digest_id: digest_arxiv-alce
source_paths:
  - data/raw/arxiv/arxiv-alce/agent_source_bundle.txt
draft_card: ../../drafts/cards/alce-retriever-and-context-utilization-gap.md
draft_provenance: ../../drafts/provenance/alce-retriever-and-context-utilization-gap.md
similarity_result: ../../drafts/similarity/alce-retriever-and-context-utilization-gap.json
comparison_provenance: ../../drafts/comparison/alce-retriever-and-context-utilization-gap.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T14:10:00+08:00
  gate_notes: 6/6 通过；三张原表数据均锁到 LaTeX 表与行号；三大挑战、ELI5 R@100=31.8 上限、context utilization gap 都有 verbatim 出处。
...
- 类型：publication_gate
- 结果：passed
- 决定时间：2026-05-27T14:10:00+08:00
- 检查要点：
  - 不是标题复述：三张表格 + 三大挑战 + 操作含义。
  - 知识密度足够：retrieval 配置 + R@k 数据 + 三种模型 passage scaling 对比 + 操作含义 + 边界（不同模型档次）。
  - 源支撑齐全：每个表格数字定位到 LaTeX 表与行号。
  - References 与 Footnotes 双章节存在。
  - frontmatter 完整合法，source_claim 类型与正文一致。
  - related 已链 ALCE 系列、mem0、ragchecker、wicer。

## 备注

- 本卡的"ELI5 R@100 = 31.8" 数字可在 v3 retrieval-design 系列中作为"corpus scale × retriever 选型决定上限"的锚点。
- comparison 显示与 v2 仅普通词撞分，new_card 决策合理。

## 相关 v3 draft 工件

- draft card: `../../drafts/cards/alce-retriever-and-context-utilization-gap.md`
- draft provenance: `../../drafts/provenance/alce-retriever-and-context-utilization-gap.md`
- similarity: `../../drafts/similarity/alce-retriever-and-context-utilization-gap.json`
- comparison provenance: `../../drafts/comparison/alce-retriever-and-context-utilization-gap.md`
