...
card: ../cards/wicer-hardware-architecture-deployment.md
material_id: arxiv-wicer
digest_id: digest_arxiv-wicer
source_paths:
  - data/raw/arxiv/arxiv-wicer/agent_source_bundle.txt
draft_card: ../../drafts/cards/wicer-hardware-architecture-deployment.md
draft_provenance: ../../drafts/provenance/wicer-hardware-architecture-deployment.md
similarity_result: ../../drafts/similarity/wicer-hardware-architecture-deployment.json
comparison_provenance: ../../drafts/comparison/wicer-hardware-architecture-deployment.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T14:30:00+08:00
  gate_notes: 6/6 通过；M4 Pro / RTX 4090 / Inferentia2 三套数字、CUDA Q8 零代价、Inferentia2 静态形状不适配论述均回到 Appendix B（L1044–1154）。
...
- 检查要点：
  - 非标题复述：正文展开三套硬件画像表 + 三条机制 + Inferentia2 结构约束 + 部署建议 + 边界。
  - 知识密度：硬件实测 / 投影数字 + 机制 + 部署建议三层。
  - 源支撑：source_ids 含 arxiv-wicer；Appendix B 多段 verbatim。
  - References / Footnotes 齐备。
  - frontmatter 完整且合法。
  - related 已填充：5 张 WiCER / anthemcreation / kunal 部署相邻卡。
...
- draft card: `../../drafts/cards/wicer-hardware-architecture-deployment.md`
- draft provenance: `../../drafts/provenance/wicer-hardware-architecture-deployment.md`
- similarity: `../../drafts/similarity/wicer-hardware-architecture-deployment.json`
- comparison provenance: `../../drafts/comparison/wicer-hardware-architecture-deployment.md`
