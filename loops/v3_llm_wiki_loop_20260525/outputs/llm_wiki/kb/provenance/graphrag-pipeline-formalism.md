...
card: ../cards/graphrag-pipeline-formalism.md
...
draft_card: ../../drafts/cards/graphrag-pipeline-formalism.md
draft_provenance: ../../drafts/provenance/graphrag-pipeline-formalism.md
similarity_result: ../../drafts/similarity/graphrag-pipeline-formalism.json
comparison_provenance: ../../drafts/comparison/graphrag-pipeline-formalism.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T10:06:00+08:00
  gate_notes: 6/6 项通过：五步函数式形式化 + 三条 chunk-RAG 没有的性质 + 与传统 RAG 三类攻击对比 + 边界，证据锚定 L178-185 / L263-287。
...
- 类型：publication_gate
- 结果：passed
- 决定时间：2026-05-27T10:06:00+08:00
- 检查要点：
  - 非标题复述：以五步形式化 + 三条结构性质 + 与传统 RAG 三类攻击对比四段展开。
  - 知识密度：函数式定义 + 摘要-as-LLM-input + 信任放大器 + 持久化几何原因 + 边界三条。
  - 源支撑：L263-275 形式化、L178-185 对比、L283-287 攻击者能力。
...
- Adoption 阶段观察：三个 v2 候选 jaccard 全靠功能词「的」「llm」撞分，无任何 GraphRAG / 知识图 / pipeline formalism 邻近卡。

## 相关 v3 draft 工件

- draft card: `../../drafts/cards/graphrag-pipeline-formalism.md`
- draft provenance: `../../drafts/provenance/graphrag-pipeline-formalism.md`
- similarity: `../../drafts/similarity/graphrag-pipeline-formalism.json`
- comparison provenance: `../../drafts/comparison/graphrag-pipeline-formalism.md`
