...
card: ../cards/memory-as-metabolism-contextualize-depth-fitted.md
...
draft_card: ../../drafts/cards/memory-as-metabolism-contextualize-depth-fitted.md
draft_provenance: ../../drafts/provenance/memory-as-metabolism-contextualize-depth-fitted.md
similarity_result: ../../drafts/similarity/memory-as-metabolism-contextualize-depth-fitted.json
comparison_provenance: ../../drafts/comparison/memory-as-metabolism-contextualize-depth-fitted.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T14:48:00+08:00
  gate_notes: 6/6 项通过；§5.4 / §7.5 / §9 多段 verbatim，D-Mem 对照清楚。
...
- depth-fitted compression 的"PO vs Developer"动机；
- 三层存储模型的"cold memory"层引入；
- 与 D-Mem 的 prior art 区分；
- §7.5 中 4 条 conformance MUST。

所有主张都直接来自 §5.4、§4、§7.5、§9。
...
- 检查要点：
  - 标题机制清晰；正文 6 节展开。
  - 知识密度极高：问题、3 承诺、3 层存储、与 D-Mem 区分、metabolic 比喻、失败模式。
  - 源支撑：§5.4 多段 + §7.5 + §9 verbatim。
  - References + Footnotes 双在；Footnotes 3 条 verbatim。
  - frontmatter 完整；related 含 5 张邻接卡。

## 备注

- 与 `memory-as-metabolism-five-operations` 卡片关系：总图 vs 专卡，双向 link。
- 与 D-Mem (arxiv:2603.18631) 有 prior-art 关系；未来若 D-Mem 入库可做 comparison。

## 相关 v3 draft 工件

- draft card: `../../drafts/cards/memory-as-metabolism-contextualize-depth-fitted.md`
- draft provenance: `../../drafts/provenance/memory-as-metabolism-contextualize-depth-fitted.md`
- similarity: `../../drafts/similarity/memory-as-metabolism-contextualize-depth-fitted.json`
- comparison provenance: `../../drafts/comparison/memory-as-metabolism-contextualize-depth-fitted.md`
