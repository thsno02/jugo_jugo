...
card: ../cards/zep-dmr-benchmark-critique.md
material_id: arxiv-zep
digest_id: digest_arxiv-zep
source_paths:
  - data/raw/arxiv/arxiv-zep/agent_source_bundle.txt
draft_card: ../../drafts/cards/zep-dmr-benchmark-critique.md
draft_provenance: ../../drafts/provenance/zep-dmr-benchmark-critique.md
similarity_result: ../../drafts/similarity/zep-dmr-benchmark-critique.json
comparison_provenance: ../../drafts/comparison/zep-dmr-benchmark-critique.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T14:30:00+08:00
  gate_notes: 6/6 通过；500 段 × 60 条、94.4% / 98.0% baseline、5 条局限与 MemGPT 复现失败均回到行 218–266。
...
- 检查要点：
  - 非标题复述：正文展开 5 条局限 + baseline 数字 + 操作含义 + 诚实边界。
  - 知识密度：数据规模 + baseline + 多条批判论点 + 替代建议。
  - 源支撑：source_ids 含 arxiv-zep；行 218 / 222 / 224 / 266 verbatim。
  - References / Footnotes 齐备。
  - frontmatter 完整且合法。
  - related 已填充：5 张 Zep / MemGPT / LongMemEval 相邻卡。
...
- draft card: `../../drafts/cards/zep-dmr-benchmark-critique.md`
- draft provenance: `../../drafts/provenance/zep-dmr-benchmark-critique.md`
- similarity: `../../drafts/similarity/zep-dmr-benchmark-critique.json`
- comparison provenance: `../../drafts/comparison/zep-dmr-benchmark-critique.md`
