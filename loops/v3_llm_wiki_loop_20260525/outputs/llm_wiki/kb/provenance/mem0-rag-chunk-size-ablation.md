...
card: ../cards/mem0-rag-chunk-size-ablation.md
material_id: arxiv-mem0
digest_id: digest_arxiv-mem0
source_paths:
  - data/raw/arxiv/arxiv-mem0/agent_source_bundle.txt
draft_card: ../../drafts/cards/mem0-rag-chunk-size-ablation.md
draft_provenance: ../../drafts/provenance/mem0-rag-chunk-size-ablation.md
similarity_result: ../../drafts/similarity/mem0-rag-chunk-size-ablation.json
comparison_provenance: ../../drafts/comparison/mem0-rag-chunk-size-ablation.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T11:59:00+08:00
  gate_notes: 6/6 项通过；chunk × k 完整网格 + 非单调曲线 + 时延-质量权衡 + 复现警告齐备。
...
- 类型：publication_gate
- 结果：passed
- 决定时间：2026-05-27T11:59:00+08:00
- 检查要点：
  - source_claim 卡给出完整网格 + 时延-质量权衡 + 操作含义，非标题复述。
  - 知识密度合格。
  - source_ids 含 `arxiv-mem0`，正文锚到 result.tex 第 1218-1264 / 1297 行 + experiment_setup.tex 第 1035 行。
...
- draft card: `../../drafts/cards/mem0-rag-chunk-size-ablation.md`
- draft provenance: `../../drafts/provenance/mem0-rag-chunk-size-ablation.md`
- similarity: `../../drafts/similarity/mem0-rag-chunk-size-ablation.json`
- comparison provenance: `../../drafts/comparison/mem0-rag-chunk-size-ablation.md`
