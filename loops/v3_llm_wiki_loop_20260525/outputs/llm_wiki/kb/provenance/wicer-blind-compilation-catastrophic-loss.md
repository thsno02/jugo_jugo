...
card: ../cards/wicer-blind-compilation-catastrophic-loss.md
material_id: arxiv-wicer
digest_id: digest_arxiv-wicer
source_paths:
  - data/raw/arxiv/arxiv-wicer/agent_source_bundle.txt
draft_card: ../../drafts/cards/wicer-blind-compilation-catastrophic-loss.md
draft_provenance: ../../drafts/provenance/wicer-blind-compilation-catastrophic-loss.md
similarity_result: ../../drafts/similarity/wicer-blind-compilation-catastrophic-loss.json
comparison_provenance: ../../drafts/comparison/wicer-blind-compilation-catastrophic-loss.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T14:30:00+08:00
  gate_notes: 6/6 通过；Table 3 五行数字、compression compliance failure 与 score-1 53–60% verbatim 都回到 L736–746 / L758–762 / L748–750。
...
- 检查要点：
  - 非标题复述：正文给出 Table 3 五行、两个独立观察、延迟侧反向代价与操作含义。
  - 知识密度：数字 + 因果归因 + 操作建议三层。
  - 源支撑：source_ids 含 arxiv-wicer；L736–746 / L758–762 verbatim。
  - References / Footnotes 齐备。
  - frontmatter 完整且合法。
  - related 已填充：5 张 WiCER / Karpathy / Locomo 相邻卡。

## 备注

与 `wicer-cegar-compile-evaluate-refine` 互为前因后果（前者诊断问题、后者给出修复），适合作为相互 related 的成对卡。与 v2 现有 4 张 wiki workflow 卡无直接重叠。

## 相关 v3 draft 工件

- draft card: `../../drafts/cards/wicer-blind-compilation-catastrophic-loss.md`
- draft provenance: `../../drafts/provenance/wicer-blind-compilation-catastrophic-loss.md`
- similarity: `../../drafts/similarity/wicer-blind-compilation-catastrophic-loss.json`
- comparison provenance: `../../drafts/comparison/wicer-blind-compilation-catastrophic-loss.md`
