...
card: ../cards/graphrag-leiden-community-hierarchy.md
material_id: arxiv-graphrag
digest_id: digest_arxiv-graphrag
source_paths:
  - data/raw/arxiv/arxiv-graphrag/agent_source_bundle.txt
draft_card: ../../drafts/cards/graphrag-leiden-community-hierarchy.md
draft_provenance: ../../drafts/provenance/graphrag-leiden-community-hierarchy.md
similarity_result: ../../drafts/similarity/graphrag-leiden-community-hierarchy.json
comparison_provenance: ../../drafts/comparison/graphrag-leiden-community-hierarchy.md
gate:
  type: publication_gate
  result: passed
  decided_at: 2026-05-27T10:04:00+08:00
  gate_notes: 6/6 项通过：Leiden 分层 + 递归构造规则 + C0-C3 单元/token 数完整且锚定到 §3.1.4-3.1.5 与 tab:community summaries。
...
- 类型：publication_gate
- 结果：passed
- 决定时间：2026-05-27T10:04:00+08:00
- 检查要点：
  - 非标题复述：以"为何分层 → 递归构造规则 → C0-C3 命名与含义 → 实践含义"四段铺开。
  - 知识密度：Leiden 算法 + 递归构造规则 + C0-C3 单元 / token 数 + token 成本 9-43 倍差异。
  - 源支撑：§3.1.4-3.1.5 行 821-844 + tab:community summaries 行 438-446。
...
- 与 `graphrag-root-community-token-efficiency` 卡片在 C0 token 数据上重叠，但本卡聚焦"层次结构本身"，那张卡聚焦"成本权衡"。
- Adoption 阶段观察：comparison 三个 v2 候选 score ≤ 0.0833，仅靠虚词「的」「作为」同形；"分层"二字在 v2 与 v3 中分别指 wiki 文档层级与图社群层级，同形不同义。

## 相关 v3 draft 工件

- draft card: `../../drafts/cards/graphrag-leiden-community-hierarchy.md`
- draft provenance: `../../drafts/provenance/graphrag-leiden-community-hierarchy.md`
- similarity: `../../drafts/similarity/graphrag-leiden-community-hierarchy.json`
- comparison provenance: `../../drafts/comparison/graphrag-leiden-community-hierarchy.md`
