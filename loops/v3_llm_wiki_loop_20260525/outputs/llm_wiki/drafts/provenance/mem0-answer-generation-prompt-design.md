...
- 若未来需要做 prompt-vs-architecture 消融，可与 MemGPT 的 K/V agent persona prompt（"DO NOT STOP SEARCHING UNTIL YOU VERIFY THAT THE VALUE IS NOT A KEY"）合并到 "prompt 起调度作用" 这一更高层 distinction。
