...
node_id:: 20260524_050034_provenance_as_core_knowledge_asset
version:: 1.0

## 为什么存在这个版本

这个版本用于把 `Provenance 是核心知识资产，不是附录` 固化为一个可引用、可审计、可修订的 KB node。它不是最终百科条目，而是初始化阶段的 adopted knowledge object。
