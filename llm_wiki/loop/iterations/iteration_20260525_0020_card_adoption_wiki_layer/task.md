...
- `task_id`: `task_20260525_0021_card_adoption_candidate_9`
- `iteration_id`: `iteration_20260525_0020_card_adoption_wiki_layer`
...
- `audit_report_path`: `llm_wiki/loop/iterations/iteration_20260525_0019_card_audit_wiki_layer/artifacts/audit_report.md`
- `target_card_path`: `llm_wiki/kb/cards/llm-wiki-wiki-layer-generated-markdown-directory.md`，仅用于存在性和覆盖冲突检查。
- `target_provenance_path`: `llm_wiki/kb/provenance/llm-wiki-wiki-layer-generated-markdown-directory.md`，仅用于存在性和覆盖冲突检查。
...
- `llm_wiki/loop/iterations/iteration_20260525_0020_card_adoption_wiki_layer/loop_status.md`
- `llm_wiki/loop/iterations/iteration_20260525_0020_card_adoption_wiki_layer/loop_delivery.md`
- `llm_wiki/loop/iterations/iteration_20260525_0020_card_adoption_wiki_layer/read_log.md`
