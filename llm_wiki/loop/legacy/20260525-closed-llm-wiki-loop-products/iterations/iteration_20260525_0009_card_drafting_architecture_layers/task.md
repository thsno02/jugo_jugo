...
- `iteration_id`: `iteration_20260525_0009_card_drafting_architecture_layers`
...
- `candidate_scope`: 仅限该来源提出的架构分层。
- `candidate_source_evidence`: `data/raw/gist_raw/karpathy-gist-llm-wiki/raw.txt:25-33`

只处理 `候选 7`。`fact_candidates.md` 只可用于核对 `候选 7` 的字段，不得把其它候选写成知识卡或混入本卡。不得读取已采纳 KB 卡片来补充事实。
...
- `llm_wiki/loop/iterations/iteration_20260525_0009_card_drafting_architecture_layers/loop_status.md`
- `llm_wiki/loop/iterations/iteration_20260525_0009_card_drafting_architecture_layers/loop_delivery.md`
- `llm_wiki/loop/iterations/iteration_20260525_0009_card_drafting_architecture_layers/read_log.md`
