...
- `audit_report_path`: `llm_wiki/loop/iterations/iteration_20260525_0037_card_audit_llm_wiki_pattern_file/artifacts/audit_report.md`
- `card_id`: `llm-wiki-pattern-file`
- `target_card_path`: `llm_wiki/kb/cards/llm-wiki-pattern-file.md`，仅用于存在性和覆盖冲突检查。
- `target_provenance_path`: `llm_wiki/kb/provenance/llm-wiki-pattern-file.md`，仅用于存在性和覆盖冲突检查。
...
- `llm_wiki/kb/cards/llm-wiki-pattern-file.md`
- `llm_wiki/kb/provenance/llm-wiki-pattern-file.md`
- `llm_wiki/kb/indexes/cards.md`
- `llm_wiki/loop/iterations/iteration_20260525_0040_card_adoption_llm_wiki_pattern_file/loop_status.md`
- `llm_wiki/loop/iterations/iteration_20260525_0040_card_adoption_llm_wiki_pattern_file/loop_delivery.md`
- `llm_wiki/loop/iterations/iteration_20260525_0040_card_adoption_llm_wiki_pattern_file/read_log.md`
